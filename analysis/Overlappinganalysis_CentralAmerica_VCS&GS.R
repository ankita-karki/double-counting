...
cookstove_files <- list.files(path = "KML file/GS_COOKSTOVE_NEW/Central America", pattern = "\\.kml$", full.names = TRUE)
avoided_def_files <- list.files(path = "KML file/VCS_REDD/Central America", pattern = "\\.kml$", full.names = TRUE)

...
cookstove_files <- list.files(path = "D:/Thesis/KML file/VCS_COOKSTOVE/Central America", pattern = "\\.kml$", full.names = TRUE)
...
overlap_centralamerica_VCS <- "D:/Thesis/Version/25.02.2024/New folder/overlap_centralamerica_vcs.gpkg"

# Save the sf object as a GeoPackage
st_write(overlap_sf, overlap_centralamerica_VCS, delete_layer = TRUE)
